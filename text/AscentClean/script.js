...
// url="https://9hn7055m-5500.inc1.devtunnels.ms";
//url="http://127.0.0.1:5500";
url="https://actshopmoney.netlify.app";
...
function scrollToProducts() {
  ...
  // You can add more interactivity here as needed
    ...
    $(document).ready(function(){
        ...
        // ------------------user loginIforation page --------------------------------------------------------------------------
          userLogSec=()=>{
                  $("#sign-up-container").hide();
                  $("#popupLoginOverlap").show();
          }
                              ...
                              product_item.setAttribute("id","product_item");
                                ...
                                `
                                      ...
                                      <h2 id="rate"> ${data[key].rate} </h2>
                                        <h3 id="rate_del"><del style=" color: #7e1414ff">  ${data[key].rate_del} </del> </h3>
                                         <button type="button" class="login-btn" onclick="order('${key}','${data[key].rate}')" >order</button>
                                `
...
// About us Funtion When  user click on aboutUs button then show all imformation
...
// --------------------Orders imformation-------------------------------------------------------------
            $("#mOrders").click(()=>{
                 location.href=`${url}/text/AscentClean/order.html`
...
showProduct();
 ...
 let order=(pname,prate)=>{

               location.href=`${url}/text/AscentClean/order/order.html?pname=${pname}&prate=${prate.replace("₹", "")}`
