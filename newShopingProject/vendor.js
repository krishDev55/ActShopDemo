...
let loadImg=()=>{
    ...
    let load_img_url=`http://localhost:8081/v1/getProductByVendorId/${empId}`;
...
let addProd=()=>{
             ...
             let prodType = document.getElementById("prodType").value ;   
             let prodPrice = document.getElementById("prodPrice").value ;   
             let prodQuantity = document.getElementById("prodQuantity").value ;   
             let prodInfo = document.getElementById("prodInfo").value ;
             let img = document.getElementById("img").value ;
             
             console.log(" product Is : ", prodname ," ---  ", prodType)
             console.log(" product price : ", prodPrice ," ---  ", prodQuantity)
             console.log(" product info : ", prodInfo ," ---  ", img)

             let empId=sessionStorage.getItem("empId");
             let token=sessionStorage.getItem(empId);
             
                    let url="http://localhost:8081/v1/saveProduct"
...
orders=()=>{
    ...
    document.getElementById("prof_main").style.display="none";
                ...
                let token=sessionStorage.getItem(empId);
                    ...
                    let url=`http://localhost:8081/v1/getOrderByVendorId/${empId}`;
...
let ord_acptBtn =(orderId ,row)=>{
    ...
    let url =`http://localhost:8081/v1/updateOrderStatusByOrderId/${orderId}/${status}`
